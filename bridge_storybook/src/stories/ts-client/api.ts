 ...
 * 
 * @export
 * @interface SimpleOutProps
 */
export interface SimpleOutProps {
    /**
     * 
     * @type {number}
     * @memberof SimpleOutProps
     */
    'output': number;
}
/**
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {SimpleProps} simpleProps 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        withDefaultSimplePost: async (simpleProps: SimpleProps, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'simpleProps' is not null or undefined
            assertParamExists('withDefaultSimplePost', 'simpleProps', simpleProps)
            const localVarPath = `/simple`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(simpleProps, localVarRequestOptions, configuration)
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async withDefaultSimplePost(simpleProps: SimpleProps, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SimpleOutProps>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.withDefaultSimplePost(simpleProps, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.withDefaultSimplePost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        withDefaultSimplePost(simpleProps: SimpleProps, options?: any): AxiosPromise<SimpleOutProps> {
            return localVarFp.withDefaultSimplePost(simpleProps, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public withDefaultSimplePost(simpleProps: SimpleProps, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).withDefaultSimplePost(simpleProps, options).then((request) => request(this.axios, this.basePath));
    }
}
